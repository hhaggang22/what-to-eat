...
public class PreferFragJpn extends Fragment{
    static String attrarray[] = new String[4];
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        MenuAdapter.items.clear();
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.prefer_frag_jpn, container, false);

        final Button prefer1_1_1 = (Button) rootView.findViewById(R.id.jpn_prefer1_1_1);    //찬, 뜨거운
        final Button prefer1_1_2 = (Button) rootView.findViewById(R.id.jpn_prefer1_1_2);
        final Button prefer1_2_1 = (Button) rootView.findViewById(R.id.jpn_prefer1_2_1);
        final Button prefer1_2_2 = (Button) rootView.findViewById(R.id.jpn_prefer1_2_2);
        final Button prefer2_1_1 = (Button) rootView.findViewById(R.id.jpn_prefer2_1_1);    //국물O,국물X
        final Button prefer2_1_2 = (Button) rootView.findViewById(R.id.jpn_prefer2_1_2);
        final Button prefer2_2_1 = (Button) rootView.findViewById(R.id.jpn_prefer2_2_1);
        final Button prefer2_2_2 = (Button) rootView.findViewById(R.id.jpn_prefer2_2_2);
        final Button prefer3_1_1 = (Button) rootView.findViewById(R.id.jpn_prefer3_1_1);    //날것O, 날것X
        final Button prefer3_1_2 = (Button) rootView.findViewById(R.id.jpn_prefer3_1_2);
        final Button prefer3_2_1 = (Button) rootView.findViewById(R.id.jpn_prefer3_2_1);
        final Button prefer3_2_2 = (Button) rootView.findViewById(R.id.jpn_prefer3_2_2);
        final Button prefer4_1_1 = (Button) rootView.findViewById(R.id.jpn_prefer4_1_1);    //밥, 밀가루
        final Button prefer4_1_2 = (Button) rootView.findViewById(R.id.jpn_prefer4_1_2);
        final Button prefer4_2_1 = (Button) rootView.findViewById(R.id.jpn_prefer4_2_1);
        final Button prefer4_2_2 = (Button) rootView.findViewById(R.id.jpn_prefer4_2_2);
        final Button result_btn = (Button) rootView.findViewById(R.id.jpn_result_btn);
        ...
        prefer4_1_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((prefer1_1_1.getVisibility() == View.VISIBLE && prefer1_2_1.getVisibility() == View.VISIBLE) ||
                        ...
                        (prefer3_1_1.getVisibility() == View.VISIBLE && prefer3_2_1.getVisibility() == View.VISIBLE)) { // 선택하지 않은 속성이 있는데 마지막 속성을 선택한 경우
